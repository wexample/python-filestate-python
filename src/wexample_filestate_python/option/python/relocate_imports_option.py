...
class RelocateImportsOption(AbstractPythonFileContentOption):
    ...
    def _apply_content_change(self, target: TargetFileOrDirectoryType) -> str:
        ...
        annotation_names_candidate: set[str] = type_annotation_names - class_level_names
        ...
        names_to_remove_from_module = (
            (runtime_local_final - runtime_used_anywhere)
            | type_only_names
            | (cast_type_names_anywhere - class_level_names - runtime_used_anywhere)
        )
